...
public class RegisterCommand implements Command{
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (userService.ifInvalidRegData(username, mail, password, confirmPassword)) {
            setResponseStatus(400, userService.getFaultRegistrationReason(username, mail, password,
        ...
        try {
            ...
            setResponseStatus(400, resourceBundle.getString("register.already.exists"), response);
