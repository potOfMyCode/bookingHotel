        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item mybutton">
                    <a class="nav-link" href="${pageContext.request.contextPath}/underSky/reserved_rooms"><fmt:message key="header.reserved.rooms"/></a>
                </li>
                <li class="nav-item mybutton">
                    <a class="nav-link" href="${pageContext.request.contextPath}/underSky/rooms"><fmt:message key="header.rooms"/></a>
                </li>
                <li class="nav-item mybutton">
                    <a class="nav-link" href="${pageContext.request.contextPath}/underSky/go_double"><fmt:message key="header.point2"/></a>
                </li>
                <li class="nav-item mybutton">
                    <a class="nav-link" href="${pageContext.request.contextPath}/underSky/go_applications"><fmt:message key="header.applications"/></a>
                </li>
