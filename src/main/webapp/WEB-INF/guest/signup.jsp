            ...
            <div class="card card-signin flex-row ">
                ...
                <div class="card-body">
                    ...
                    <form class="form-signin">
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item dropdown mybutton">
                                        ...
                                        <div class="crystal shadow-c dropdown-menu dropdown-menu-right animate slideIn" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="${pageContext.request.contextPath}/underSky/go_registration"
                                            ...
                                            <a class="dropdown-item" href="${pageContext.request.contextPath}/underSky/go_registration?curLang=uk"
                                               style="padding-left: 12px;">
                        ...
                        <a class="d-block text-center mt-2 small" href="${pageContext.request.contextPath}/underSky/go_login?${pageContext.request.queryString}"><fmt:message key="header.login"/></a>
                    </form>
