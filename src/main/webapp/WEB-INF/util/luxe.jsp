...
<div id="container">
    ...
    <div class="container-fluid patternback">
        <div class="container contentblock" style="background-color: #f6f6fd;">
            <img src="${pageContext.request.contextPath}/picture/booking/suite-room-title.jpg"
            ...
            <div class="row">
                <div class="component col-md-8 col-sm-12">
                    ...
                    <div class="item-page" >
                        ...
                        <div class="page-header">
                            <h1 itemprop="headline"><fmt:message key="luxe"/> </h1>
                        </div>

                        <div itemprop="articleBody">
                            <p><fmt:message key="luxe.desc"/><br></p>

                            <h3><fmt:message key="room.features"/></h3>
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <ul>
                                        <li><fmt:message key="room.area.luxe"/></li>
                                        <li><fmt:message key="bed.luxe"/></li>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" >
                        ...
                        <div class="carousel-inner" role="listbox" >
                            <div class="carousel-item active" style="background-image: url(${pageContext.request.contextPath}/picture/booking/suite-hotel-1.jpg);
                                    background-size: contain"></div>
                            <div class="carousel-item" style="background-image: url(${pageContext.request.contextPath}/picture/booking/suite-hotel-2.jpg);
                                    background-size: contain"></div>
                            <div class="carousel-item" style="background-image: url(${pageContext.request.contextPath}/picture/booking/suite-hotel-3.jpg);
                                    background-size: contain"></div>
                            <div class="carousel-item" style="background-image: url(${pageContext.request.contextPath}/picture/booking/suite-hotel-4.jpg);
                                    background-size: contain"></div>
                        </div>
                ...
                <div class="right col-md-4 col-sm-12">
                    ...
                    <div class="list-group">
                        ...
                        <a href="${pageContext.request.contextPath}/underSky/go_luxe?${pageContext.request.queryString}" class="list-group-item active"><fmt:message key="luxe"/></a>
                    </div>
