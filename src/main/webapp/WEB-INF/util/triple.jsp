...
<div id="container">
    ...
    <div class="container-fluid patternback">
        <div class="container contentblock" style="background-color: #f6f6fd;">
            <img src="${pageContext.request.contextPath}/picture/booking/triple-room-title.jpg"
                 style="width: 100%; margin: 0; padding: 0; background-size: 100%" >
            <div class="contenttop row no-gutters margin-minus">
            ...
            <div class="row">
                <div class="component col-md-8 col-sm-12">
                    ...
                    <div class="item-page">
                        ...
                        <div class="page-header">
                            <h1 itemprop="headline"><fmt:message key="triple(luxe)"/></h1>
                        </div>

                        <div itemprop="articleBody">
                            <p><fmt:message key="triple.desc"/><br></p>

                            <h3><fmt:message key="room.features"/></h3>
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <ul>
                                        <li><fmt:message key="room.area.triple"/></li>
                                        <li><fmt:message key="bed.triple"/></li>
                                        ...
                                        <li><fmt:message key="convertible.sofa"/></li>
                                    </ul>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <ul>
                                        <li><fmt:message key="soft.amchairs"/></li>
                                        <li><fmt:message key="miniBar"/></li>
                                        <li><fmt:message key="Telephone"/></li>
                                        <li><fmt:message key="bathroom"/></li>
                                        <li><fmt:message key="Towels"/></li>
                                        <li><fmt:message key="hairDryer"/></li>
                                        <li><fmt:message key="balcony"/></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" >
                        ...
                        <div class="carousel-inner" role="listbox" >
                            <div class="carousel-item active" style="background-image: url(${pageContext.request.contextPath}/picture/booking/triple-1.jpg);
                                    background-size: contain"></div>
                            <div class="carousel-item" style="background-image: url(${pageContext.request.contextPath}/picture/booking/triple-2.jpg);
                                    background-size: contain"></div>
                            <div class="carousel-item" style="background-image: url(${pageContext.request.contextPath}/picture/booking/triple-3.jpg);
                                    background-size: contain"></div>
                            <div class="carousel-item" style="background-image: url(${pageContext.request.contextPath}/picture/booking/triple-4.jpg);
                                    background-size: contain"></div>
                        </div>
                ...
                <div class="right col-md-4 col-sm-12">
                    ...
                    <div class="list-group">
                        ...
                        <a href="${pageContext.request.contextPath}/underSky/go_triple?${pageContext.request.queryString}" class="list-group-item active"><fmt:message key="triple(luxe)"/></a>
